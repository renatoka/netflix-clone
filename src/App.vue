    ...
    <div class="our-story-top-content">
      ...
      <div class="our-story-cards">
        <div class="our-story-hero-card">
          ...
          <h4 id="email-form-title">Ready to watch? Enter your email to create or restart your membership.</h4>
        </div>
        <div class="our-story-registration-field">
          <input type="text" placeholder="Email address" id="emailField">
          <a href="#"><button id="getStarted">Get Started ></button></a>
        </div>
      </div>
    </div>
  </header>
    ...
    <div class="our-story-wrapper">
      <div class="our-story-icons">
        <div class="our-story-icon">
          <div class="our-story-icon-left">
            ...
            <h3 id="our-story-icon-subheading">Watch on Smart TVs, Playstation, Xbox,
        ...
        <div class="our-story-icon">
          <div class="our-story-icon-left">
            <h1 id="our-story-icon-heading">Download your shows to watch offline.</h1>
            <h3 id="our-story-icon-subheading">Save your favorites easily and always have something to watch.
            </h3>
          </div>
          <div class="our-story-icon-right">
        ...
        <div class="our-story-icon">
          <div class="our-story-icon-left">
            ...
            <h3 id="our-story-icon-subheading">Stream unlimited movies and TV shows on your phone, tablet, laptop
        ...
        <div class="our-story-icon">
          <div class="our-story-icon-left">
            ...
            <h3 id="our-story-icon-subheading">Send kids on adventures with their favorite characters in a space
      ...
      <div class="our-story-faq">
        ...
        <div class="our-story-faq-content">
          ...
          <button class="faq" @click="showFaqInfoTwo">How much does Netflix cost?</button>
          <div class="faq-answer" v-if="this.faqVisible.two">
            ...
            fee. Plans range from EUR7.99 to EUR11.99 a month. No extra costs, no contracts.
          </div>
          <button class="faq" @click="showFaqInfoThree">Where can I watch?</button>
          ...
          <button class="faq" @click="showFaqInfoFive">What can I watch on Netflix?</button>
          ...
          <button class="faq" @click="showFaqInfoSix">Is Netflix good for kids?</button>
