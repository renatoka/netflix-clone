<template>
    <div class="movies">
            ...
            <div class="header">
                ...
                <div class="secondaryHeader">
                    ...
                    <img class="profile-icon"
                        src="https://occ-0-6571-1490.1.nflxso.net/dnm/api/v6/K6hjPJd6cR6FpVELC5Pd6ovHRSk/AAAABXeeIVtmgzU089rwEnRNnxk6Q1GHEkPghoK2PHnziJv4WrrO_QxZ4crVPJIe3wjusYZjCmN1sxolKdCbQ1jli_HtH2hAzsU.png?r=fcd"
                        alt="" />
                </div>
            </div>
        </div>
        <div class="mainView">
            <div class="billboard">
                <img :src="selectedImage" alt="" srcset="" class="background">
                <div class="info-wrapper">
                    <img :src="this.coverImg" alt="" srcset="" class="n-series-img">
                    <div class="info-wrapper-text">
                        {{ this.text }}
                    </div>
                    <div class="info-wrapper-buttons">
            ...
            <div class="slider-content">
                <div class="slider-container">
                    <div class="slider-item" v-for="(item, index) in showImages" :key="index">
                        <h1 class="slider-heading">{{item.title}}</h1>
                        <div class="slider-images">
                            <img :src="image" class="slider-image" :key="imageIndex"
...
export default {
    ...
    created() {
        ...
        alert('Reminder to myself to update this code once I learn more about Vue.js and how to do so. Also add Slider functionality.')
    }
}
